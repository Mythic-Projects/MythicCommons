...
public interface ThrowingQuadFunction<T, U, V, W, R, E extends Throwable> {
    ...
    static <T, U, V, W, R, E extends Throwable> ThrowingQuadFunction<T, U, V, W, R, E> of(
            @NotNull QuadFunction<T, U, V, W, R> function
    ) {
    ...
    static <T, U, V, W, R, E extends Throwable> ThrowingQuadFunction<T, U, V, W, R, E> fail(
